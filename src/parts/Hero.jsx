    ...
    <section className="hero">
      <Fade bottom>
        <div className="w-full lg:w-1/2 xl:pl-12 sm:pr-2 mt-8">
          ...
          Elevate Your IT Solutions with 
            {' '}
            <br />
            Kode<span className="text-theme-purple ">Force</span>
          </h1>

          <p className="font-light text-xl text-gray-400 leading-relaxed mb-16">
          Welcome to <Button type="link" target="_blank" className="text-lg text-theme-purple font-light" isExternal>KodeForce</Button>, your trusted partner in delivering exceptional IT services tailored for small and mid-range companies. Our team of experts is dedicated to helping you build robust, scalable, and innovative IT solutions that drive business growth and efficiency. At KodeForce, we harness cutting-edge technology to transform your vision into reality, ensuring high-quality outcomes that meet your unique needs. Join us and leverage our expertise to stay ahead in the competitive IT landscape.
          </p>
